  ...
  return (
    <>
      <div className="container mx-auto flex flex-col items-center lg:items-start p-5">
        <h1 className="text-primaryDarker font-semibold w-full lg:text-left text-xl lg:text-[2.2rem]">Os melhores locais encontrados para sua viagem</h1>
        ...
        <div className="flex flex-wrap gap-4 lg:grid lg:grid-cols-4 lg:gap-10 lg:mt-6 lg:pb-16">
          {travels.length > 0 ?
            ...
            <Button variant="outlined" onClick={() => router.push('/')}>Volte para ver mais!</Button>
          }
        </div>
      </div>
    </>
